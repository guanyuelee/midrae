...
#!/usr/bin/env python
"""
LR-AE add MMD regularization to ACAI while keep linear interpolation unchanged.
"""
...
class LRAE(train.AE):
    ...
    def model(self, latent, depth, scales, advweight, advdepth, reg, wgt_mmd):
        ...
        # we only add mmd regularization to ACAI while keep linear interpolation unchanged.
...
if __name__ == '__main__':
    ...
    flags.DEFINE_float('wgt_mmd', 1.0, 'weight of MMD regularization.')
    app.run(main)
